        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 transition-all shadow-lg hover:shadow-green-500/50 disabled:opacity-50"
            >
              {loading ? (
                <>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setProfileData({ ...profileData, farmSize: e.target.value })
                }
                className="w-full px-4 py-3 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            </div>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { key: 'productAlerts', label: 'Alertes produits (stock faible)' },
